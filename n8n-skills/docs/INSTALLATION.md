...
See [../skills/README.md](../skills/README.md) for the current skill catalog and naming map.
...
You should see the skills you uploaded listed.
...
Expected response:
```
[n8n Expressions & Data Mapping skill activates]
...
Expected: The relevant installed skills should activate and work together.
