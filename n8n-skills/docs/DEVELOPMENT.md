...
```
n8n-skills/
├── CONTRIBUTING.md           # Contributor workflow and naming rules
├── skills/                   # Skill implementations
│   ├── README.md             # Skill catalog (slug ↔ display name map)
...
├── optional root docs         # README.md, LICENSE, plugin metadata if present
└── .gitignore
```
...
### 1. Stable Slugs, Flexible Display Names

Treat the folder slug as the stable identifier.

Examples:
- Folder slug: `n8n-expression-syntax`
...
Use the display name for:
- README titles
- Catalogs
- Contributor-facing documentation

### 2. Update the Catalog with Every Structural Change

When you add, remove, or rename a skill, update:

- `skills/README.md`
- `CONTRIBUTING.md`
- Any affected installation or packaging docs

### 3. Prefer Discoverable Structure over Cleverness

A contributor should be able to answer these questions quickly:

- Which folder is the real repository root?
- What is the stable id for this skill?
- Where are this skill's evaluations?
- Which docs are for agents vs developers?

If the answer is not obvious from file names and nearby docs, simplify it.
...
- `skills/README.md` (catalog entry)
...
- Keep the folder slug stable and human-readable
